...
from pipeline.table_ingestion_job import TableIngestionJob

def run_pipeline_from_config(config_path: str = "config.yaml") -> None:
    ...
    for source_cfg in cfg["sources"]:
        for table_cfg in source_cfg["tables"]:
            ...
            job = TableIngestionJob(source, destination)
            job.run()